...
public class ProxyFactoryBean extends ProxyCreatorSupport
	...
	private void checkInterceptorNames() {
		if (!ObjectUtils.isEmpty(this.interceptorNames)) {
			...
			if (this.targetName == null && this.targetSource == null /*EMPTY_TARGET_SOURCE*/) {
	...
	private synchronized void initializeAdvisorChain() throws AopConfigException, BeansException {
		...
		if (!ObjectUtils.isEmpty(this.interceptorNames)) {
			...
			if (this.interceptorNames[this.interceptorNames.length - 1].endsWith(GLOBAL_SUFFIX) &&
					this.targetName == null && this.targetSource == null/*EMPTY_TARGET_SOURCE*/) {
	...
	private TargetSource freshTargetSource() {
		if (this.targetName == null) {
			...
			return null/*(target instanceof TargetSource ? (TargetSource) target : new SingletonTargetSource(target))*/;
		}
	}
